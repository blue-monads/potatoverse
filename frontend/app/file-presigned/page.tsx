                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="mt-8 bg-gray-50 rounded-lg p-6">
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                            ...
                            <p>
                                <strong>Why is my upload failing?</strong><br />
                                Common issues: expired token, wrong filename, or network problems. Make sure your file name exactly matches what the token expects.
                            </p>
                            <p>
