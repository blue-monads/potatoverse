      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Simple Modal</h2>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <button
              ...
              className="w-full bg-primary-600 hover:bg-primary-600 text-white px-4 py-2 rounded-lg transition-colors"
            >
              Open Large Modal
            </button>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Full Screen</h2>
            <p className="text-gray-600 mb-4">
...
const BigOne = ({ modal }: { modal: ModalHandle }) => {
  return (<>(
        <div className="h-full flex flex-col">
          <div className="flex-1 bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-lg">
